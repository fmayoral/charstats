Habilidades.core.greater_magic_weapon = {
    id: 'greater_magic_weapon',
    bundle: 'core',
...
CharStats.efectos.greater_magic_weapon_ataque = function (pj, bonus) {
...
CharStats.efectos.greater_magic_weapon_danio_bonificador = function(pj, bonus){
